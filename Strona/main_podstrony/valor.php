...
$sql = "UPDATE trenerzy SET id_druzyny='1' WHERE nick_trenera='".$_SESSION["nick"]."'";

if ($conn->query($sql) === TRUE) {
    $_SESSION["druzyna"] = "Valor";
}
?>
<div class="team_valor team_thanks">
    <div class="team_text team_thanks" style="height:auto;color:red;">
        <div style="font-size:35px;">Dziękujemy za wybór drużyny Valor!</div>
